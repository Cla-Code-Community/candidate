...
export default function RightSide() {
  ...
  return (
    <main className="relative flex w-full lg:w-1/2 flex-col justify-between px-6 py-10 sm:px-12 lg:px-16 xl:px-20 bg-white dark:bg-neutral-900 min-h-screen transition-colors duration-300 font-sans overflow-hidden">
      ...
      <form
        className="relative z-10 space-y-6 w-full max-w-2xl mx-auto my-auto"
      ...
      >
        ...
        <p className="mt-4 text-sm text-center text-gray-500 dark:text-neutral-400 font-medium">
          ...
          <a
            href="/register"
            className="ml-1 font-semibold bg-gradient-to-r text-[#0EBB69] bg-clip-text text-transparent underline underline-offset-2 hover:opacity-80 transition-opacity"
          >
            Cadastre-se
          </a>
        </p>
