...
export function HeroSection() {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-[90vh] flex flex-col items-center justify-start pt-16 md:pt-24 pb-0 overflow-hidden bg-transparent font-sans"
    >
      <motion.div
      ...
      <motion.div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          ...
          <span className="text-blue-500 font-light">&gt;</span> varre dezenas
          de plataformas automaticamente, transforma candidatos em profissionais
          preparados e entrega as melhores oportunidades filtradas para você.
        </motion.p>
